 ...
 */
final class Version20230716121348 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, entity_id INT NOT NULL, depreciation_group_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, code INT NOT NULL, account_asset INT DEFAULT NULL, account_depreciation INT DEFAULT NULL, account_repairs INT DEFAULT NULL, INDEX IDX_64C19C181257D5D (entity_id), INDEX IDX_64C19C1C75DF7FD (depreciation_group_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE depreciation_group (id INT AUTO_INCREMENT NOT NULL, entity_id INT NOT NULL, name VARCHAR(255) DEFAULT NULL, code INT NOT NULL, method INT NOT NULL, years INT NOT NULL, months INT NOT NULL, coefficient INT NOT NULL, rate_first_year INT NOT NULL, rate INT NOT NULL, rate_increased_price INT NOT NULL, INDEX IDX_6973654081257D5D (entity_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
